...
class CompilationEngine:
  ...
  def __subroutine(self):
    ...
    Grammer:
    - '~constructor/method/function~ type subroutineName ~(~ parameterList ~)~ subroutineBody'
    """
  ...
  def compile_expression(self) -> None:
    ...
    # Writing all terms as long as we have a binary operator
